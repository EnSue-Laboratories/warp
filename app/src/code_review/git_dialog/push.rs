...
use crate::code_review::git_dialog::{
    render_branch_section, render_chevron_icon, render_file_list, show_git_error_toast, show_toast,
    GitDialog, GitDialogAction, GitDialogEvent, GitDialogMode,
};
...
pub(super) fn finish_push(
    ...
    match result {
        ...
        Err(e) => {
            ...
            show_git_error_toast(&e.to_string(), ctx);
        }
    }
